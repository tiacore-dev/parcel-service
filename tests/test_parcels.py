...
async def test_add_parcel(test_app: AsyncClient, jwt_token_admin):
    ...
    data = {
        ...
        "sender_warehouse": str(uuid4()),
        "sender_personal_data": str(uuid4()),
        "sender_company": "Тест Отправитель",
        "sender_phone": "+79999999999",
        "sender_email": "sender@example.com",
        "sender_telegram": "@sender",
        "sender_coordinates_latitude": "55.7558",
        "sender_coordinates_longitude": "37.6176",
        "pickup_estimated_date": "2025-06-25",
        "pickup_time_from": "2025-06-25T10:00:00",
        "pickup_time_to": "2025-06-25T12:00:00",
        "sender_additional_info": "Тестовая доп. информация",
        "recipient_city": str(uuid4()),
        "recipient_address": "ул. Получательская, д.2",
        "recipient_warehouse": str(uuid4()),
        "recipient_personal_data": str(uuid4()),
        "recipient_company": "Тест Получатель",
        "recipient_phone": "+79998887766",
        "recipient_email": "recipient@example.com",
        "recipient_telegram": "@recipient",
        "recipient_coordinates_latitude": "59.9343",
        "recipient_coordinates_longitude": "30.3351",
        "delivery_estimated_date": "2025-06-26",
        "delivery_time_from": "2025-06-26T10:00:00",
        "delivery_time_to": "2025-06-26T12:00:00",
